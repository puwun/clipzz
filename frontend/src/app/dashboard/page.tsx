...
export default async function DashboardPage() {
  ...
  const formattedFiles = userData.uploadedFiles.map((file) => ({
    ...
    // createdAt: format(new Date(file.createdAt), "MM/dd/yyyy"), // Consistent date format
    createdAt:  new Date(file.createdAt), // Consistent date format // Consistent date format
  }));
